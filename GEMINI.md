# Gemini Agent Guidelines: First-ADE Compliance Framework

This document outlines the strict technical, architectural, and procedural standards for development on the **First-ADE Compliance Framework** codebase using Gemini-based agents.
